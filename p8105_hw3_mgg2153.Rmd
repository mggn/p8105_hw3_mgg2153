...
The resulting dataset has **`r nrow(ny_weather_df)`** and **`r ncol(ny_weather_df)`**
...
three different plots, to de-clutter the year on the x-axis
...
tmax_v_tmin/ snow_dist_1 /snow_dist_2 / snow_dist_3

ggsave(file = 'snow_dist_1.png')  
ggsave(file = 'snow_dist_2.png')
ggsave(file = 'snow_dist_3.png')
ggsave(file = 'tmax_v_tmin.png')
